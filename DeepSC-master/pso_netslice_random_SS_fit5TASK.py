...
log_dir = f"./Records/netslice/SS/fitTASK/{script_name}_{start_time}/"
...
from net_slice_random_SS_5TASK import main_compute
...
class PSO:
    ...
    def pso(self):
        ...
        plt.ylabel(u"最大值")  
        plt.title(u"迭代过程")  
        fig1_path = os.path.join(log_dir, 'PSO_最大值_net.png')
        ...
        plt.ylabel(u"X1")  
        plt.title(u"X1识别曲线")  
        fig2_path = os.path.join(log_dir, 'PSO_x1识别曲线_net.png')
        ...
        plt.ylabel(u"X2")  
        plt.title(u"X2识别曲线")  
        fig3_path = os.path.join(log_dir, 'PSO_x2识别曲线_net.png')
...
if __name__ == '__main__':
    ...
    results_dir = f"./Records/netslice/SS/fitTASK/{script_name}_{start_time}/"
