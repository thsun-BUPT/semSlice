...
log_dir = f"./Records/netslice/SS/fitSNR/{script_name}_{start_time}/"
...
from net_slice_random_SS import main_compute
...
if __name__ == '__main__':
    ...
    results_dir = f"./Records/netslice/SS/fitSNR/{script_name}_{start_time}/"
