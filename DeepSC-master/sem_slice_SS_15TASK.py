...
parser.add_argument('--task_5_vocab', default='./europarl/vocab_en.json', type=str)
parser.add_argument('--task_6_vocab', default='./europarl/vocab_en.json', type=str)
parser.add_argument('--task_7_vocab', default='./europarl/vocab_en90%.json', type=str)
parser.add_argument('--task_8_vocab', default='./europarl/vocab_en90%.json', type=str)
parser.add_argument('--task_9_vocab', default='./europarl/vocab_en90%.json', type=str)
parser.add_argument('--task_10_vocab', default='./europarl/vocab_en90%.json', type=str)
parser.add_argument('--task_11_vocab', default='./europarl/vocab_en90%.json', type=str)
parser.add_argument('--task_12_vocab', default='./europarl/vocab_en80%.json', type=str)
parser.add_argument('--task_13_vocab', default='./europarl/vocab_en80%.json', type=str)
parser.add_argument('--task_14_vocab', default='./europarl/vocab_en80%.json', type=str)
parser.add_argument('--task_15_vocab', default='./europarl/vocab_en80%.json', type=str)
...
parser.add_argument('--task_5', default='./europarl/test_data_en.pkl', type=str)
parser.add_argument('--task_6', default='./europarl/test_data_en.pkl', type=str)
parser.add_argument('--task_7', default='./europarl/test_data-en90%.pkl', type=str)
parser.add_argument('--task_8', default='./europarl/test_data-en90%.pkl', type=str)
parser.add_argument('--task_9', default='./europarl/test_data-en90%.pkl', type=str)
parser.add_argument('--task_10', default='./europarl/test_data-en90%.pkl', type=str)
parser.add_argument('--task_11', default='./europarl/test_data-en90%.pkl', type=str)
parser.add_argument('--task_12', default='./europarl/test_data-en80%.pkl', type=str)
parser.add_argument('--task_13', default='./europarl/test_data-en80%.pkl', type=str)
parser.add_argument('--task_14', default='./europarl/test_data-en80%.pkl', type=str)
parser.add_argument('--task_15', default='./europarl/test_data-en80%.pkl', type=str)
