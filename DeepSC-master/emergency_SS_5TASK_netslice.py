...
dict_tasks_list=dict(tasks_list) 
...
tasks_list_after,slices_list_after,task_data_set_after,deepsc_models_after = tasks_after(args,tasks_list)   
...
def main_compute_after(X): 
    ...
    for i in range(slices_num_emergency):
        ...
        for j in range(len(slices_list_after[i])):
            ...
            Encoder_idx = dict_tasks_list[slices_list_after[i][j]]-1
